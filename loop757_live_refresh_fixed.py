...
# Load live data from published Google Sheets
...
# Streamlit page config and design
...
# Auto-fill ZIP using location
components.html("""<script>navigator.geolocation.getCurrentPosition(function(pos) {
